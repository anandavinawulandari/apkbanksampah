...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="row">
    <div class="col" style="">
     ...
     <b><p class='text-left' style='font-size:35px '>di BANK SAMPAH APP</p></b>
     <br>  
     <b><p class='text-left' style='font-size:38px '>
     @if (Route::has('login'))
                                   
                    <p><a href="{{url('/login')}}" class="btn btn-block text-sm text-white-200 dark:text-white-500 d-grid col-12 button4">Get Started</i></a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>
                    @endif
    </p></b>
    ...
    <!-- <div class="col" style="background-image: url('{{asset('AdminLTE-3.2.0')}}/dist/img/hm4.png'); background-repeat: no-repeat;"  width="200"> -->
     ...
     <!-- <i class='fas fa-desktop' style='font-size:36px'></i> -->
     <p><img src="{{asset('AdminLTE-3.2.0')}}/dist/img/logoo.png" height="500" width="600" alt="image_sekolah" style="" align="right"> </p>
    <br>  
    <br>  
    <br>  
